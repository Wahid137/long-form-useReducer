      ...
      >
        ...
        <div className='flex flex-col w-full max-w-xs'>
          ...
          <div className='flex justify-between items-center gap-2 '>
            <label onClick={() => dispatch({ type: "DECREMENT" })} className='bg-indigo-500 text-lg text-white rounded h-10 w-10 btn'
            >
              -
            </label>
            ...
            <label onClick={() => dispatch({ type: "INCREMENT" })} className='bg-indigo-500 text-lg text-center items-center flex justify-center text-white rounded h-10 w-10'>
              +
            </label>
          </div>
        </div>
